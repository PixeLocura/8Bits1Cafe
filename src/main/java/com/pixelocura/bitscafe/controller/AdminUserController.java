...
public class AdminUserController {
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "201", description = "Usuario creado exitosamente",
            content = @Content(schema = @Schema(implementation = UserDTO.class))),
        @ApiResponse(responseCode = "400", description = "Datos de entrada inválidos o el usuario ya existe con ese nombre de usuario o correo electrónico",
            content = @Content)
    })
    @PostMapping
    ...
    @Operation(
        ...
        description = "Recupera un usuario por su UUID.",
        tags = {"users", "get"}
    )
    @ApiResponses(value = {
    ...
    @Operation(
        ...
        description = "Recupera un usuario por su nombre de usuario.",
        tags = {"users", "get"}
    )
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Usuario encontrado",
    ...
    @Operation(
        ...
        description = "Recupera un usuario por su dirección de correo electrónico.",
        tags = {"users", "get"}
    )
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Usuario encontrado",
    ...
    @Operation(
        ...
        description = "Actualiza la información de un usuario existente por su UUID.",
        tags = {"users", "update"}
    )
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Usuario actualizado exitosamente",
            content = @Content(schema = @Schema(implementation = UserDTO.class))),
        @ApiResponse(responseCode = "400", description = "Datos de entrada inválidos o el nombre de usuario/correo electrónico ya está en uso por otro usuario",
            content = @Content),
        @ApiResponse(responseCode = "404", description = "Usuario no encontrado",
            content = @Content)
    })
    ...
    @Operation(
        ...
        description = "Elimina un usuario del sistema por su UUID.",
        tags = {"users", "delete"}
    )
    @ApiResponses(value = {
